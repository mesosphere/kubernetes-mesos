...
It also assumes that `${KUBERNETES_MASTER}` is the HTTP URI of the host running the Kubernetes-Mesos framework, which currently hosts the Kubernetes API server (e.g. http:/<span>/</span>10.2.3.4:8888).
