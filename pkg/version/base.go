...
// provided via go ldflags. It provides an approximation of the Kubernetes-Mesos
...
//
// When releasing a new Kubernetes-Mesos version, this file should be updated to
...
var (
	...
	gitMinor     string = "4.0"            // minor version, numeric possibly followed by "+"
	gitVersion   string = "v0.4.0"         // version from git, output of $(git describe)
